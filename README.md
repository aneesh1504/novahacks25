...
## Table of contents
- [Teacher-Student Matching Platform](#teacher-student-matching-platform)
    - [Overview](#overview)
    - [Key tech](#key-tech)
    ...
    - [Quick start](#quick-start-teacherstudent-matching)
    - [Detailed setup](#detailed-setup)
    - [How the backend scores and assigns](#how-the-backend-scores-and-assigns)
    - [Troubleshooting](#troubleshooting)
    - [Roadmap](#roadmap-ideas)
- [Voice Interviewer](#voice-interviewer)
    - [Features](#features)
    - [Overview](#overview-1)
    - [Run locally](#run-locally-with-vosk-speech-to-text-and-xtts-neural-voice)
    - [Files](#files-voice-interviewer)
    - [Browser support](#browser-support)
    - [Notes](#notes)
- [Port usage and conflicts](#port-usage-and-conflicts)
- [License](#license)
